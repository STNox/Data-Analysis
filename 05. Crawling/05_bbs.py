...
for page in range(total_pages):
    ...
    for tr in trs[1:]:
        ...
        try:
            ...
            reply_count = 0
            title = tds[1].text
        bids.append(tds[0].text); titles.append(title); names.append(tds[2].text)
        times.append(tds[3].text); view_counts.append(tds[4].text); reply_counts.append(reply_count)
    ul = driver.find_element_by_css_selector('.pagination')
    lis = ul.find_elements_by_tag_name('li')
    lis[page+2].click()